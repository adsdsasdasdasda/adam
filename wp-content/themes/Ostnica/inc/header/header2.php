<header id="site-header" class="header-footer-group cd-site-header">
      <div class="section-inner header-inner row px-5">
        <div class="col-md-3 ">
          <div class="site-logo">
            <?php
            if ( has_custom_logo() ) {
        ...
        <div class="col-md-7">
          <div class="desktop-menu cd_menu_text_style">
              <?php
...
<!--         <div class="col-md-2">
            <button class="btn btn-warning contact-btn float-end" type="button">Contant Us</button>
        </div> -->
      </div>
    </header>